...
# 💻SpeakStyle – AI-Powered Chat Bot
...
What makes it stand out is how it bridges web development with AI — it's not just about mimicking text, but creating a practical tool that reflects my passion for combining modern tech stacks with real-world NLP applications.


## 🛠️ Skills & Technologies

- 💻 Languages: Java | Python | SQL 
- 🧠 Core: Data Structures & Algorithms | CS fundamentals  
- 🌐 Web:  HTML | CSS |JavaScript | React | Node(Express)
- 🤖 AI/ML: Pytorch(TorchVision) | Tensorflow
- 🛠️ Tools: VS Code| GitHub


## 📌 Explore My Journey

This space highlights my **projects**, **learnings**, and **growth** as an aspiring software engineer.  
Thanks for visiting! 🚀
